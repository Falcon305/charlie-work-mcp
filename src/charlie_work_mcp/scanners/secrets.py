...
_RULES = [
    ...
    Rule(
        ...
        "Anthropic API key",
        ("sk-ant-",),
        r"(sk-ant-[a-z0-9]{2,}-[A-Za-z0-9_\-]{20,})",
        3.5,
        True,
    ),
    Rule("openai-key", "OpenAI API key", ("sk-",), r"\b(sk-[A-Za-z0-9]{20,})\b", 3.5, False),
    Rule(
        "slack-token",
        "Slack token",
        ("xoxb", "xoxp", "xoxa", "xoxr"),
    ...
    Rule(
        ...
        ("secret", "token", "apikey", "api_key", "passwd", "password"),
        r"""(?i)(?:secret|token|api[_-]?key|passwd|password)\s*[:=]\s*['"]([A-Za-z0-9+/_\-]{16,})['"]""",
        3.5,
        False,
    ),
]
